 ...
 * sopraprojet.harrypotter.ecole.Cours; import
 * sopraprojet.harrypotter.exception.PanierException; import
 * sopraprojet.harrypotter.service.CompteService; import
 * sopraprojet.harrypotter.service.PanierService;
 * 
 * @RestController
 * 
 ...
 * 
 * @GetMapping("") public List<Panier> getAll() { return panierService.getAll();
 * }
 * 
 * @JsonView(JsonViews.Common.class)
 * 
 * @GetMapping("/compte/{id}") public List<Panier> getById(@PathVariable Integer
 * id) { Compte c = compteService.getById(id); return
 * panierService.findPanierWithCompteDanssLePanier(c); }
 * 
 * @JsonView(JsonViews.Common.class)
 * 
 ...
 * public List<Panier> ajoutProduit(@PathVariable Integer
 * id, @Valid @RequestBody Produit produit) { // Compte compte =
 * compteService.getByIdWithPanier(id); // List<Panier> listepanier=
 * compte.getPanier(); // Panier panier= new Panier(); //
 * panier.setArticles(produit); // listepanier.add(panier); //
 * compte.setPanier(listepanier); // panierService.save(panier); //
 * compteService.save(compte); // return listepanier; // }
 * 
 * 
 * @JsonView(JsonViews.Common.class)
 * 
