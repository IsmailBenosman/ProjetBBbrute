...
class AuthentificationTests {
	...
	void createbd() {
		...
		Produit produit1= new Produit(b1,"Balétoile XXI", 200.0, "Le Balétoile XXI est un balai de course. Il est utilisé par l'équipe de Quidditch des États-Unis lors de la Coupe du Monde de Quidditch de 2014","eclairdefeu.png");
		Produit produit2= new Produit(b1,"La Bombe bleue", 200.0, "La Bombe bleue  est un balai familial sûr, stable et équipé d'une sirène antivol","nimbus2000.jpg");
		Produit produit3= new Produit(b1,"Le Brossdur 1", 200.0, "Le Brossdur 1 est un modèle de balais de course, produit en 1926 par la Compagnie des balais Brossdur","nimbus2001.png");
		...
		*/Produit produit30= new Produit(b6,"Le Boursouf" ,200, "Le Boursouf est un charognard qui mange n'importe quoi avec sa longue langue extensible et notamment les restes de repas ou les araignées, mais il apprécie plus particulièrement les crottes de nez des sorciers","vautour.jpg");
		...
		Produit produit32= new Produit(b6,"Le Chat Blanc" ,9, "Le chat blanc a souvent des beaux yeux bleus qui créent un contraste saisissant avec sa robe d'un blanc neige","chat.jpg");
		...
		*/Produit produit41= new Produit(b11,"La chouette des bois" ,10, "La chouette des bois possède une vision binoculaire ainsi qu'une audition directionnelle exceptionnelle. Ces atouts font d'elle un redoutable prédateur nocturne. Elle se nourrit essentiellement de petits rongeurs et de mulots","hibou.jpg");
		...
		*/Produit produit53= new Produit(b7,"Baguette de Chadwick Boot" ,10, "Frêne épineux, corne de serpent cornu","baguette.jpg");
		Produit produit54= new Produit(b7,"Baguette de Jacob " ,10,
				  "Bois d'érable, ventricule de dragon","baguette1.jpg");
		...
		*/Produit produit89 = new Produit(b2, "Menthe poivrée", 3.60 ,"Une plante très utilisée pour les confiseries","menthepoivree.jpg");
		Produit produit90 = new Produit(b2, "Branchiflore", 11 ,"Une plante qui permet de respirer sous l'eau","branchiflore.gif");
		Produit produit91 = new Produit(b2, "Têtes de coquelicot", 7.25 ,"Utile pour des potions du sommeil ou d'amnésie","coquelicot.png");
		...
		Produit produit97 = new Produit(b3, "Jus de citrouille", 2.50 ,"Un jus très prisé des sorciers","citrouille.png");
		Produit produit98 = new Produit(b3, "Jus d'oeuillet", 3.25 ,"Un jus vitaminé qui pétille","oeuillet.jpg");
		...
		Produit produit110 = new Produit(b8, "Oreilles a rallonge", 9 ,"Pour écouter à distance","oreille.png");
		Produit produit111 = new Produit(b8, "Marécage portable", 6 ,"Un petit coin de nature à portee de main","marecage.jpg");
		Produit produit112 = new Produit(b8, "Pendu réutilisable", 3 ,"Trouvez le bon sort ou il aura la corde au cou","pendu.jpg");
